      ...
      <div className="flexRow flexCol justify-sb align-center">
        <div data-aos="fade-right">
          <p className="uppercase bold-500 textColor ls-1 mtb-10">
            <span className="primaryColor">Hello,</span> I am Rinku Sharma
          </p>
          ...
          <div className="flexRow" style={{ margin: "30px 0" }}>
            ...
            <div id="downcv">
              <a href="https://drive.google.com/file/d/1xiS9ol2wVE8lnLsbUVw7YjctlFDaL0kE/view?usp=sharing" target="">Download CV</a>
            </div>
          </div>
        </div>
